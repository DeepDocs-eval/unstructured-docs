...
3. The Unstructured API URL for Unstructured Ingest was provided to you when your Unstructured account was created. 
  ...
  <Note>
       The default URL for Unstructured Ingest is the same as the default URL for the legacy Unstructured Partition Endpoint: `https://api.unstructured.io/general/v0/general`. 
